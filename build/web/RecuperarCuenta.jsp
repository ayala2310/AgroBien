            ...
            <div class="form">
                ...
                <main class="main">
                    <div  class="columna columna2" >
                        ...
                        <h5>No te preocupes, ingresa tu <b>nombre de usuario</b> o <b>correo</b> y te enviaremos un enlace a tu correo registrado para que desbloquees tu cuenta.</h5>
                        <br>
                        <form >
                            <div class="inputContainer">
                            ...
                            <%
                                ...
                                if (usuarioCorreo != null) {
                                    ResultSet rs = usu.recuperarContraseña(usuarioCorreo);
                                    String res = "";
                                    while (rs.next()) {
                            ...
                            %>
                            <div>
                                <p style="color:red"> Usuario o correo no válido.</p>
                            </div>
                            <%
                            } else {
                                String resp = notif.enviarCorreo(usuario, correo, "Recuperación de cuenta");
                                if (!resp.equals("")) {
                            %>
                            <div>
                                <p style="color:red"> No se pudo enviar el correo para desbloquear la cuenta.</p>
                            </div>
                            <%
                            } else {
                            %>
                            <div>
                                <p style="color:blue"> Se envió un enlace a su correo </p>
                            </div>
                            <%
                                        }
                                    }
