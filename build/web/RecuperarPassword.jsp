            ...
            <div class="form">
                ...
                <main class="main">
                    <div  class="columna columna2" >
                        ...
                        <h5>No te preocupes, ingresa tu <b>nombre de usuario</b> o <b>correo</b> y te enviaremos un enlace a tu correo registrado para que restaures tu contraseña.</h5>
                        <br>
                        <form >
                            <div class="inputContainer">
                            ...
                            <%
                                ...
                                String resp = notif.enviarCorreo(usuario, correo, "Recuperación de contraseña");
                                if (!resp.equals("")) {
                            %>
                            <div>
                                <p style="color:red"> No se pudo enviar el correo para reestablecer la contraseña.</p>
                            </div>
                            <%
                            } else {
                            %>
