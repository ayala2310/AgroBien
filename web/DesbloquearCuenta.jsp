    ...
    <body>
        <div class="signupFrm">
            <div class="form">
                ...
                <h1 class="title">Hola, estás a un paso de desbloquear tu cuenta.</h1><a href="Principal.jsp"><img class="logo" src="imagenes/logoPrincipal.png" alt="40" width="80" title="Portal web AgroBien"/></a>
