        ...
        <nav class="menu navbar navbar-default navbar-expand-lg navbar-light">
            ...
            <div id="navbarCollapse" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    -->
                    <li id="idAgronomo"  class="active" style="display:${mostrarAgronomo}"><a href="AgronomoServlet">Agrónomos</a></li>
            ...
            <div class="columnaBlog columnaBlog2"> 
                ...
                <div class="container">
                    <div class="table-responsive">
                        <div class="col-sm-12"><h2><b>Contactar Agrónomo</b></h2></div>
                        <p>
                            <br>
                        <hr>
                        </p>

                        <form class="publicarBlog" action="AgronomoServlet?accion=enviarCorreoAgronomo" method="POST">

                             <label >Para: </label>
                            <input name="correoAgronomo" class="form-control searchBlog" type="text" value="${correoContacto}" readonly>
                            <p>
                                <label >Mensaje: </label>
                                <textarea rows="3" name="mensajeAgronomo" class="form-control searchBlog" type="text" placeholder="Ingrese mensaje."></textarea>
                            <div>
                                <button class="searchBtnBlog" type="submit">Contactar</button>
                            </div>
                        </form>
                    ...
                    <div class="container">
                        ...
                        <form class="publicarBlog" action="AgronomoServlet" method="POST">
                            <input type="submit" class="btn btn-primary" name="accion" value="Regresar">
                        </form>
